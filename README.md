In case you are not familiar with circuit breaker pattern, you can easily fix it by reading this [nice article](https://learn.microsoft.com/en-us/azure/architecture/patterns/circuit-breaker)
